...
{
    public function createRole($str, $name)
    {
    ...
    public function deleteRole($str)
    {
    ...
    public function createPermission($str, $name)
    {
    ...
    public function deletePermission($str)
    {
    ...
    protected function getIdList($roles, $permissions)
    {
        ...
        return [$roles_id_list, $permissions_id_list];
    }
